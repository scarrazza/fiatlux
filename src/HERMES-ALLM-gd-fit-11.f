...
c$$$*     input: x, Q2, W2
c$$$*     output: sigmatot [barn], F2
c$$$*----------------------------------------------------
c$$$      program gdfit
c$$$      double precision dx,dq2,dw2,sigmatot,F2
c$$$      double precision dsigmatot,dF2
c$$$      double precision aprmass
c$$$      character*1 target
c$$$      parameter (aprmass=0.938272029d0)
c$$$
c$$$      target='p'
c$$$      dx=0.005d0
c$$$      dq2=500d0
c$$$      dw2=aprmass*aprmass+dq2*(1.d0/dx-1.d0)
c$$$
c$$$      !
c$$$      !dw2=3000d0
c$$$      !dq2=0.0d0
...
c$$$      write(*,*)'w2=',dw2, ' [GeV2]' 
c$$$
c$$$      call gd_fit_11(dx,dQ2,dW2,target,sigmatot,F2,dsigmatot,dF2)
c$$$      
c$$$      write(*,*) 'F2= ',F2,' +- ' , dF2
c$$$      write(*,*) 'sigmatot= ',sigmatot,' +- ', dsigmatot, '[barn]'
c$$$            
c$$$      end
...
c------------------------------------------------------------------------
     ...
     c     (1.d0+gam2)/(1.d0-dx)/(1.d0-dx)
      ...
      enddo
      df2=sqrt(abs(df2))
      dsigmatot=sqrt(abs(dsigmatot))*hbarc2
      goto 10
      endif
      if (dQ2.eq.0.d0) then
         do i=1,23
